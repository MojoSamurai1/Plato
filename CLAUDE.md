...
- Staging: `https://staging-plato.mojosamurai.com/wp-json/plato/v1`
- Production: `https://plato.mojosamurai.com/wp-json/plato/v1`
...
### Hosting
- **SiteGround** (mojosamurai.com account, user `u2612-zgifxcodusds`)
- **Production URL**: `plato.mojosamurai.com`
- **Staging URL**: `staging-plato.mojosamurai.com`
- **SSH Host**: `ssh.mojosamurai.com` (port 18765)
- **SSH Key**: `~/.ssh/plato-deploy-key`
...
| Secret | Description |
|--------|-------------|
| `STAGING_SSH_KEY` / `PROD_SSH_KEY` | Private SSH key (`~/.ssh/plato-deploy-key`) |
| `STAGING_SSH_HOST` / `PROD_SSH_HOST` | `ssh.mojosamurai.com` |
| `STAGING_SSH_USER` / `PROD_SSH_USER` | `u2612-zgifxcodusds` |
| `STAGING_SSH_PORT` / `PROD_SSH_PORT` | `18765` |
| `STAGING_DEPLOY_PATH` | `/home/u2612-zgifxcodusds/www/staging-plato.mojosamurai.com/public_html` |
| `PROD_DEPLOY_PATH` | `/home/u2612-zgifxcodusds/www/plato.mojosamurai.com/public_html` |
