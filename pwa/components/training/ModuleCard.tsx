...
export default function ModuleCard({ module, onGenerate, onClick }: ModuleCardProps) {
  ...
  return (
    <div
      ...
      onClick={hasScenarios ? onClick : onGenerate}
    >
      ...
      {hasScenarios ? (
        ...
        <div className="w-full text-sm bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 px-3 py-2 rounded-lg font-medium text-center">
          Open Module &rarr;
        </div>
      )}
    </div>
